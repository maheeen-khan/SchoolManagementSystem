    ...
    <div className="container-fluid" style={{ top:'86px' ,position:"fixed" , height: "calc(100vh - 60px)"}}>
      ...
      >
            ...
            <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start " id="menu">
              ...
              <li>
                <Link to="Teachers" className="nav-link px-0 align-middle ">
              ...
              <li>
                ...
                <ul className="collapse nav flex-column ms-1 " id="submenu2">
                  <li>
                    <Link to="Students_Attendance" className="nav-link px-0 "style={{fontFamily:"Georgia", fontStyle:"bold", fontSize:"18px", color:"#22322aff"}}>Students</Link>
                  </li>
                  <li>
                    <Link to="Teachers_Attendance" className="nav-link px-0 " style={{fontFamily:"Georgia", fontStyle:"bold", fontSize:"18px", color:"#22322aff"}}>Teachers</Link>
                  </li>
                </ul>
              </li>

              <li>
                <Link to="Fee" className="nav-link px-0 align-middle">
              ...
              <li>
                <Link to="Certificate" className="nav-link px-0 align-middle">
